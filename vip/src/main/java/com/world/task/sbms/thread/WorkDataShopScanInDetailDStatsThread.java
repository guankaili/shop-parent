...
public class WorkDataShopScanInDetailDStatsThread extends Thread {
    ...
    public void run() {
        ...
        param.add(workDataShopScanInDetailDStats.getProvinceCode());
        param.add(workDataShopScanInDetailDStats.getProvinceName());
        ...
        param.add(workDataShopScanInDetailDStats.getLargeAreaName());
        ...
        param.add(workDataShopScanInDetailDStats.getShopScanInDetailDate());
