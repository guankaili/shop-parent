			...
			<form autocomplete="off" name="searchForm" id="searchContaint">
				<div class="form-search" id="searchContainer">
					<div class="formline">
							...
							<span class="formcon"><input id="userName" name="userName" pattern="limit(0,65)" size="20" type="text"/></span>
							
							<span class="formtit">管理员：</span> 
							<span class="formcon"><input id="adminName" name="adminName" pattern="limit(0,25)" size="20" type="text"/></span>
							
							<span class="formtit">路径：</span> 
							<span class="formcon"><input id="urls" name="urls"  size="20" type="text"/></span>
...
$(function(){ 
 	vip.list.ui();
	vip.list.funcName = "";
	vip.list.basePath = "/admin/log/access/";
