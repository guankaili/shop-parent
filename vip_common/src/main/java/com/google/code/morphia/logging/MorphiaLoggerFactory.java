...
@SuppressWarnings({"unchecked"})//com.google.code
public final class MorphiaLoggerFactory {
    private static LogrFactory loggerFactory;

    private static final List<String> FACTORIES = new ArrayList(Arrays.asList("com.google.code.morphia.logging.slf4j.SLF4JLogrImplFactory",
