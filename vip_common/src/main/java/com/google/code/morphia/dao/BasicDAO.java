...
public class BasicDAO<T, K> implements DAO<T, K> {
    ...
    public BasicDAO(final Class<T> entityClass, final Mongo mongo, final Morphia morphia, final String dbName , final String entityAlias) {
    	this.entityAlias = entityAlias;
    ...
    public BasicDAO(final Class<T> entityClass, final Mongo mongo, final Morphia morphia, final String dbName) {
        this(entityClass, mongo, morphia, dbName, null);
    }
     ...
     */
    protected BasicDAO(final Mongo mongo, final Morphia morphia, final String dbName , final String entityAlias) {
    	this.entityAlias = entityAlias;
        initDS(mongo, morphia, dbName);
    ...
    protected BasicDAO(final Mongo mongo, final Morphia morphia, final String dbName) {
        this(mongo, morphia, dbName, null);
    }
