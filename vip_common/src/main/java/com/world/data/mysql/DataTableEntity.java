...
public class DataTableEntity {
	...
	//获取第index个字段名称,如果index字段不存在,就抛出ArrayIndexOutOfBoundsException异常
	...
	public void setColumnNames(String columnName,int index){
		if(index<=this.columnCount){
	...
	//获取字段类型
	public int getColumnTyoe(int index){
		if(index<=this.columnCount)
