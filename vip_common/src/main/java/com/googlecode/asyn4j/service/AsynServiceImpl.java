...
public class AsynServiceImpl extends ApplicationContext implements AsynService {
	...
	public void addWorkWithSpring(String target, String method,
			Object[] params, AsynCallBack asynCallBack, WorkWeight weight) {
		// TODO Auto-generated method stub
		
	}

	public BlockingQueue<Runnable> getWorkQueqe() {
		return workQueue;
	}
	
	public long getExcuteNum(){
		return executeWorkNum.get();
	}
	
	
	public long getBalance(){
		return totalWork.get() - executeWorkNum.get();
	}
}
