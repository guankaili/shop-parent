...
public class ConsistencyHash {
     ...
     */
    public void init() {
         shards.add("192.168.0.0");
         shards.add("192.168.0.1");
         shards.add("192.168.0.2");
//         shards.add("192.168.0.3");
	 ...
	 */
     ...
     public static void main(String[] args) {
         ...
         /****
          * user1分布在：192.168.0.2
			user2分布在：192.168.0.2
			user3分布在：192.168.0.0
			user4分布在：192.168.0.0
			user5分布在：192.168.0.2
			user6分布在：192.168.0.0
			user7分布在：192.168.0.1
			user8分布在：192.168.0.2
			user9分布在：192.168.0.2
          */
         
         String[] users = new String[]{"user1" , "user2" , "user3" , "user4", "user5", "user6", "user7", "user8", "user9", "user10"};
         
         for(String s : users) {
             Object obj = hash.getShardInfo(hash.hash(hash.computeMd5(s),ran.nextInt(hash.VIRTUAL_NUM)));
