...
public class GoogleAuthenticator {
	...
	private final static Logger log = Logger.getLogger(GoogleAuthenticator.class.getName());
	...
	public static String getQRBarcodeURL(String user, String host, String secret) {
		String format = "https://chart.googleapis.com/chart?cht=qr&chs=150x150&choe=UTF-8&chld=L|1&chl=otpauth://totp/%s:%s%%3Fsecret%%3D%s";
//		String format = "https://chart.googleapis.com/chart?chs=150x150&choe=UTF-8&chld=L%%7C0&cht=qr&chl=otpauth://totp/%s:%s%%3Fsecret%%3D%s";
