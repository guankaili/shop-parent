 ...
 */
public class DataDealerRgoodsStatsThread extends Thread{
    private static Logger logger = Logger.getLogger(DataDealerRgoodsStatsThread.class);
    private List<DealerGoodsStats> dealerGoodsStatsList;
    private CountDownLatch countDownLatch;

    public DataDealerRgoodsStatsThread(List<DealerGoodsStats> dealerGoodsStatsList, CountDownLatch countDownLatch) {
    ...
    public void run() {
        ...
        try{
            //1、插入数据
            String sql = "insert into data_dealer_rgoods_stats (dealer_code,dealer_name,province_code,province_name," +
                    "brand_code,brand_name,YEAR,ret_goods_quantity_m1,ret_goods_quantity_m2,ret_goods_quantity_m3," +
                    "ret_goods_quantity_m4,ret_goods_quantity_m5,ret_goods_quantity_m6,ret_goods_quantity_m7,ret_goods_quantity_m8," +
                    "ret_goods_quantity_m9,ret_goods_quantity_m10,ret_goods_quantity_m11,ret_goods_quantity_m12,create_date) " +
                    " values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
