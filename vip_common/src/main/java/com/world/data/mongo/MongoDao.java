...
public class MongoDao<T, K> extends BasicDAO<T, K> implements Dao,Serializable {

	public String lan = "en";///默认英文
	...
	public String LanFormat(String key, String... p){
		return Lan.LanguageFormat(lan,key, p);
	}

  protected static Logger log = Logger.getLogger(MongoDao.class.getName());
  protected static MorphiaMongo mm = MorphiaMongoUtil.getMorphiaMongo();

  protected MongoDao(Mongo mongo, Morphia morphia, String dbName , String entityAlias) {
    super(mongo, morphia, dbName , entityAlias);
  }

  protected MongoDao(Mongo mongo, Morphia morphia, String dbName) {
    super(mongo, morphia, dbName , null);
  }

  protected MongoDao(Mongo mongo, Morphia morphia) {
    this(mongo, morphia, DEFAULT_DBNAME);
  }

  public MongoDao(String entityAlias) {
    this(mm.getMongo(), mm.getMorphia(), DEFAULT_DBNAME , entityAlias);
  }

  protected MongoDao() {
      this(mm.getMongo() , mm.getMorphia());
  }
